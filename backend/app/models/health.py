...
import sqlalchemy
from sqlalchemy import String, Date, DateTime, UniqueConstraint, Enum as SA_ENUM
...
class Mood(Base):
    ...
    mood_state: Mapped[str] = mapped_column(SA_ENUM("EXCELLENT", "GOOD", "NEUTRAL", "BAD", "TERRIBLE", name="mood_enum", create_type=False))
